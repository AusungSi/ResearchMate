...
def test_research_search_prefers_ranked_venue_over_arxiv(db_session):
    service = ResearchService(openclaw_client=FakeOpenClawClient(), wecom_client=None)
    original_quality_rerank_enabled = service.settings.research_search_quality_rerank_enabled
    service.settings.research_search_quality_rerank_enabled = True
    ...
    service.settings.research_search_quality_rerank_enabled = original_quality_rerank_enabled
